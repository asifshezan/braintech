...
<!-- Services Section Start -->
    @php
        $services = App\Models\Service::where('service_status',1)->orderBy('service_order','DESC')->limit(6)->get();
    @endphp
                        ...
                        <div class="front-part">
                            <div class="front-content-part">
                                 ...
                                 <div class="front-title-part">
                                     <h3 class="title"><a href="software-development.html">{{ $service->service_title }}</a></h3>
                                 </div>
                        ...
                        <div class="back-front">
                            <div class="back-front-content">
                                <div class="back-title-part">
                                    <h3 class="back-title"><a href="#">{{ $service->service_title }}</a></h3>
                                </div>
                                <div class="back-desc-part">
                                    <p class="back-desc">{{ $service->service_subtitle }}</p>
                                </div>
                                <div class="back-btn-part">
                                    <a class="readon view-more" href="{{ $service->btn_url }}">{{ $service->btn_name }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
