        ...
        <div class="card-header card_header bg-dark">
          <div class="row">
            <div class="col-md-8 card_header_title">
              <i class="fab fa-gg-circle"></i>All Gallery Information</div>
            <div class="col-md-4 card_header_btn">
              <a class="btn btn-sm btn-secondary chb_btn" href="{{ url('dashboard/gallery/add') }}"><i class="fas fa-plus-circle"></i> Add Gallery</a>
            </div>
          </div>
        </div>
              ...
              <table id="allDataTable" class="table table-bordered table-striped table-hover custom_table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $data->gallery_creator }}</td>
                    <td>{{ $data->gallery_publish }}</td>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="#" id="delete" data-bs-toggle="modal" data-bs-target="#softDeleteModal" data-id="{{ $data->gallery_id }}">Delete</a>
                        </div>
                    </div>
                    </td>
                  </tr>
