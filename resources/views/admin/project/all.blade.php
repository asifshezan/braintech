        ...
        <div class="card-header card_header bg-dark">
          <div class="row">
            <div class="col-md-8 card_header_title">
              <i class="fab fa-gg-circle"></i>All Projects Information</div>
            <div class="col-md-4 card_header_btn">
              <a class="btn btn-sm btn-secondary chb_btn" href="{{ url('dashboard/project/add') }}"><i class="fas fa-plus-circle"></i> Add Project</a>
            </div>
          </div>
        </div>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ url('dashboard/project/view/'.$data->pro_slug) }}">View</a>
                                <a class="dropdown-item" href="{{ url('dashboard/project/edit/'.$data->pro_slug) }}">Edit</a>
                                <a class="dropdown-item" href="#" id="delete" data-bs-toggle="modal" data-bs-target="#softDeleteModal" data-id="{{ $data->pro_id }}">Delete</a>
                        </div>
                    </div>
                    </td>
                  </tr>
...
<div class="modal fade" id="softDeleteModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <form method="post" action="{{url('dashboard/project/softdelete')}}">
      @csrf
