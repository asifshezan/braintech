                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ url('dashboard/teammember/view/'.$data->team_slug) }}">View</a>
                                <a class="dropdown-item" href="{{ url('dashboard/teammember/edit/'.$data->team_slug) }}">Edit</a>
