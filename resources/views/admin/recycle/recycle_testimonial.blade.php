        ...
        <div class="card-header card_header bg-dark">
          <div class="row">
            <div class="col-md-8 card_header_title">
              <i class="fab fa-gg-circle"></i>All Recycle Testimonial Information</div>
          </div>
        </div>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ url('dashboard/testimonial/restore/'.$data->test_slug) }}">Restore</a>
                                <a class="dropdown-item" href="#" id="delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="{{$data->test_id}}">Delete</a>
                        </div>
                    </div>
                    </td>
                  </tr>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <form method="post" action="{{url('dashboard/testimonial/delete')}}">
      @csrf
