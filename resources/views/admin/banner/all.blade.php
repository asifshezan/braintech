        ...
        <div class="card-header card_header bg-dark">
          <div class="row">
            ...
            <div class="col-md-4 card_header_btn">
              <a class="btn btn-sm btn-secondary chb_btn" href="{{ url('dashboard/banner/add') }}"><i class="fas fa-plus-circle"></i> Add Banner</a>
            </div>
          </div>
        </div>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{url('dashboard/banner/view/'.$data->ban_id)}}">View</a>
                                <a class="dropdown-item" href="{{url('dashboard/banner/edit/'.$data->ban_id)}}">Edit</a>
                                <a class="dropdown-item" href="#" id="delete" data-bs-toggle="modal" data-bs-target="#softDeleteModal" data-id="{{$data->ban_id}}">Delete</a>
                        </div>
                    </div>
                    </td>
                  </tr>
