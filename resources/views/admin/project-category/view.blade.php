          ...
          <div class="card-header card_header bg-dark">
            <div class="row">
              <div class="col-md-8 card_header_title">
                <i class="fab fa-gg-circle"></i>View Project Category</div>
              <div class="col-md-4 card_header_btn">
                <a href="{{url('dashboard/project-category')}}" class="btn btn-sm btn-secondary chb_btn"><i class="fas fa-th"></i> All Categories</a>
              </div>
            </div>
          </div>
